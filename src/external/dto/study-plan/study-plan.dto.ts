...
export type StudyPlanCourseDto = { id: string; courseKey: string; keyCode: string; keyNumber: string; name: string; hours: number; credits: number; semester: number; position: number };
