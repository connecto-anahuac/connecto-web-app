	...
	return (
		<div
			className={cn(
				...
				isHighlighted
					? "border border-Primary bg-PrimaryContainer-low text-onPrimaryContainer-low"
			...
			{isHidden ? null : (
				<>
					...
					<div className="mt-1.5 flex w-full flex-col items-center gap-0.5">
						<span className={cn("leading-none", isHighlighted ? "text-onPrimaryContainer-low" : "text-OnSurface/40")}>
							{startTime}
						</span>
						{/* <div className={cn("h-px w-full", isHighlighted ?  "text-onPrimaryContainer-low" : "text-OnSurface-40")} /> */}
						<TildeIcon  className={cn("h-2", isHighlighted ?  "text-onPrimaryContainer-low" : "text-OnSurface/60")} />
                        <span className={cn("leading-none", isHighlighted ? "text-onPrimaryContainer-low" : "text-OnSurface/40")}>
							{endTime}
						</span>
					</div>
