// import { DataViewValueType } from "@/components/table/dataView.types";
...
//  */
// // export const OPERATORS_BY_VALUE_TYPE: Record<DataViewValueType, Operator[]> = {
// //   text: ["contains", "eq", "in"],
...
// export function getOperatorsForDataViewValueType(valueType: DataViewValueType): Operator[] {
//   return OPERATORS_BY_VALUE_TYPE[valueType];
// }

// const NUMERIC_LABEL_VALUE_TYPES: ReadonlySet<DataViewValueType> = new Set<DataViewValueType>([
//   "number",
//   "date",
// ]);
